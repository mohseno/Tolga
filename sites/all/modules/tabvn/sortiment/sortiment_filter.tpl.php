<h1 class="portfolio-heading font_heading02 color_black">
  <?php print theme_get_setting('sortiment_heading', 'proma'); ?>
</h1>
<?php
$terms = array();
$vid = NULL;
$vid_machine_name = 'sortiment_categories';
...
<div class="filterable">
  <ul id="portfolio-nav">
    <li class="current"><a href="#" data-filter="*"><?php print t('Alla'); ?></a><span>/</span></li>
    <?php if (!empty($terms)): ?>
